...
public:
    // Constructor and destructor
    CudaFixedSizeAllocator(size_t blockSize, size_t initialBlocks, int deviceId, AllocFlags defaultFlags = AllocFlags::None);
...
private:
    ...
    struct Chunk {
        ...
        Chunk(void* mem, size_t count) : deviceMemory(mem), blockCount(count) {
